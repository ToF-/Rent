...
T{
    ...
    ." LT-PIVOT seek address of 1st item >= pivot" CR
        4096 MYARRAY 0 [] CELL-  LT-PIVOT MYARRAY 0 [] ?S
        4096 MYARRAY 1 [] CELL-  LT-PIVOT MYARRAY 3 [] ?S
    
    ." GT-PIVOT seek address of 1st item <= pivot" CR
        256  MYARRAY 5 [] CELL+  GT-PIVOT MYARRAY 5 [] ?S
        4096 MYARRAY 4 [] CELL+  GT-PIVOT MYARRAY 4 [] ?S
        42   MYARRAY 5 [] CELL+  GT-PIVOT MYARRAY 1 [] ?S
